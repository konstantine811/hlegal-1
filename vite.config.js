  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        publicationsEntry: '/pages/publications-entry/publications-entry.html',
        service: '/pages/service/service.html',
        serviceEntry: '/pages/service-entry/service-entry.html',
        team: '/pages/team/team.html',
        teamEntry: '/pages/team-entry/team-entry.html'
      },
      plugins: [
        babel({
